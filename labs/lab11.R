...
##############################################################################
# 03. You need the `smodels` package. Make sure you can load it here:

library(smodels)

# If not, run this code (otherwise you shouldn't need to again):

install.packages("devtools")
devtools::install_github("statsmaths/smodels")

##############################################################################
# 04 As before, it will be useful to group summarize the dataset and join the
# metadata.
...
##############################################################################
# 05. Address one of the following prompts. Your end goal should be to produce
