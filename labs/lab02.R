...
# name of the data frame followed by a dollar sign, and the column name
# (without quotes). Try using it to get the "names" column:



# There is one important difference between the dollar sign and the brackets;
# with brackets a new, smaller data frame is returned. With the dollar sign
# only a vector is given back. For use this usually should not matter, but
# can be a source of bugs in advanced R coding.
